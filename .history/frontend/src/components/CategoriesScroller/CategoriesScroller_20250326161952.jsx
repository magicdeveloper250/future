...
useEffect(()=>{
  ...
  return (
    <div className="w-full">
        ...
        <button
          onClick={() => scroll('left')}
          className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 p-2 rounded bg-white shadow-md hover:bg-gray-100 transition-opacity ${
          ...
          {categories.length > 0 ? (
             categories.map((type) => (
              <button
                ...
                className={`p-1 rounded-sm transition-colors w-max flex-none ${
                  selectedFilter === type
        ...
        <button
          ...
          className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 rounded bg-white shadow-md hover:bg-gray-100 transition-opacity ${
