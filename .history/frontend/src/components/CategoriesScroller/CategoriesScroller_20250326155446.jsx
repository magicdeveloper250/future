  ...
  return (
    <div className="w-full">
          ...
          {categories.length > 0 ? (
             categories.map((type) => (
              <button
                ...
                className={`p-1 rounded-md transition-colors w-auto ${
                  selectedFilter === type
        ...
        <button
          ...
          className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 rounded bg-transparent shadow-md hover:bg-gray-100 transition-opacity ${
