...
import CategoriesScroller from "../CategoriesScroller/CategoriesScroller";
...
const Categories = () => {
  ...
  return (
    <div className="w-full px-4 py-8">
        ...
        <CategoriesScroller categories={categoryTypes} onSelectCategory={setSelectedFilter}/>
      ...
      <div className="relative">
        ...
        {filteredProducts.length>0&&filteredProducts.length>MAX_PRODUCTS &&selectedFilter !=="All"?<Link
          to={`/category/${filteredProducts[0]?.categoryId}`}
          className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 rounded-md text-black bg-white shadow-md no-underline  hover:bg-gray-100 transition-opacity font-extrabold ${
