          ...
          <div className="w-full lg:w-2/5 text-white space-y-6 z-10 mb-8 lg:mb-0">
            ...
            <div className="pt-6 flex flex-wrap gap-4">
              ...
              <Link 
                ...
                state={{category:categories[currentCategory]}}
                className="border border-white text-sky-500 hover:border-red-500 hover:text-red-500 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 px-6 py-3 rounded-full text-lg font-medium transition duration-300 ease-in-out no-underline"
