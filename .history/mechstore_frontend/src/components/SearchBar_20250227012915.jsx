    ...
    <div ref={wrapperRef} className="relative w-full max-w-md" role="search">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-10 py-3 text-base border rounded-lg transition-shadow duration-200 focus:outline-none focus:ring-2 ${
        ...
        {query && (
          <button
            onClick={clearSearch}
            className="absolute right-3 top-3.5 text-gray-400 hover:text-gray-600 focus:outline-none focus:text-gray-600 transition-colors duration-150"
