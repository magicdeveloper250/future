      ...
      >
        <Box className="mobile-drawer">
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            ...
            <IconButton onClick={() => setOpenMenu(false)} className="text-gray-500">
              <X className="h-5 w-5" />
            </IconButton>
          </div>
          ...
          <div className="border-t border-gray-200 mt-4 pt-4 px-4">
            <Link 
              to="/login" 
              className="flex items-center space-x-3 w-full px-4 py-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors text-gray-800"
            >
          ...
          <div className="mt-auto p-4 text-center text-gray-500 text-sm border-t border-gray-200 mt-6">
