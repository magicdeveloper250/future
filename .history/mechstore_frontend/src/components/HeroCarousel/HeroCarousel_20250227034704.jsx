        ...
        <div className="container mx-auto px-6 h-full flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-2/5 text-white space-y-6 z-10 mb-8 lg:mb-0">
            ...
            <div className="pt-6 flex flex-wrap gap-4">
              <button 
                className="group flex items-center bg-primary hover:bg-primary focus:ring-2 focus:ring-red-400 focus:ring-offset-2 focus:ring-offset-slate-900 px-6 py-3 rounded-full text-lg font-medium transition duration-300 ease-in-out"
