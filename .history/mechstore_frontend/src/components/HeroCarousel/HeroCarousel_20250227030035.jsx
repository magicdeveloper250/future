        ...
        <div className="container mx-auto px-6 h-full flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-2/5 text-white space-y-6 z-10 mb-8 lg:mb-0">
            <div className="flex items-center">
              ...
              <span className="text-red-400 uppercase tracking-wider font-medium text-sm">
                Featured Collection
              </span>
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h2 className="text-5xl md:text-6xl font-bold leading-tight mt-2 text-white">
            ...
            <div className="pt-6 flex flex-wrap gap-4">
              <button 
                className="group flex items-center bg-red-500 hover:bg-red-600 focus:ring-2 focus:ring-red-400 focus:ring-offset-2 focus:ring-offset-slate-900 px-6 py-3 rounded-full text-lg font-medium transition duration-300 ease-in-out"
              ...
              <Link 
                ...
                className="border border-white hover:border-red-500 hover:text-red-500 focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 px-6 py-3 rounded-full text-lg font-medium transition duration-300 ease-in-out"
          ...
          <div className="relative w-full lg:w-3/5 h-[400px] lg:h-[600px]">
            <AnimatePresence mode="wait">
              <motion.div
                key={currentCategory}
              ...
              >
                {filteredProducts && filteredProducts.length > 0 ? (
                  <div 
                    className={`w-full h-full rounded-lg overflow-hidden shadow-2xl bg-slate-800 ${
                  ...
                  <div className="w-full h-full rounded-lg overflow-hidden shadow-2xl relative group">
