          ...
          <div className="w-full lg:w-2/5 text-white space-y-6 z-10 mb-8 lg:mb-0">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-lg md:text-md font-bold leading-tight mt-[0.5px] text-white px-2">
                      ...
                      return (
                        ...
                        >
                          ...
                          <img
                            ...
                            className="w-full h-[450px] rounded-md object-cover transition-transform duration-500 group-hover:scale-110"
