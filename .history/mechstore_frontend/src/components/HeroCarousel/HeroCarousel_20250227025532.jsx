        ...
        <div className="container mx-auto px-6 h-full flex items-center">
          ...
          <div className="hidden lg:block w-1/2">
            ...
            {filteredProducts.length>0?<div 
                className={`absolute inset-0 rounded-md overflow-hidden shadow-2xl transform transition-transform hover:scale-105 duration-500 ease-in-out grid grid-cols-${filteredProducts.length>1?2:1} gap-2 `}
                style={{ 
